...
func localizeCommands() {
	...
	historyCmd.Short = i18n.T("history.short")
	historyCmd.Example = i18n.T("history.example")
	setFlagUsage(historyCmd, "days", i18n.T("history.flag.days"))
	setFlagUsage(historyCmd, "all-stores", i18n.T("history.flag.all_stores"))
	setFlagUsage(historyCmd, "sales", i18n.T("history.flag.sales"))
	storesCmd.Short = i18n.T("stores.short")
