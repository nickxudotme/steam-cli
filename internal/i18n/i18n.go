...
var en = map[string]string{
	...
	"flag.itad_key":              "advanced pricing API key; defaults to STEAM_CLI_ITAD_KEY",
	...
	"history.short":              "Show Steam price history for an app, with optional all-store expansion",
	"history.example":            "  steam-cli history 264710\n  steam-cli history 264710 --days 30\n  steam-cli history 264710 --all-stores",
	"stores.short":               "List shop mappings used by the advanced pricing backend",
	...
	"price.flag.enhanced":        "include advanced pricing insights from the optional third-party pricing API",
	"app.flag.news":              "number of news items to include; 0 disables news fetch",
	"app.flag.enhanced":          "include advanced pricing insights from the optional third-party pricing API",
	...
	"deals.flag.filter":          "list filter: specials, discountedtopsellers, preordertopsellers, topsellers, new, comingsoon",
	"deals.flag.any":             "comma-separated conditions where any may match: discounted, preorder",
	"deals.flag.all":             "comma-separated conditions where all must match: discounted, preorder",
	...
	"history.flag.days":          "load price changes from the last N days; 0 keeps the API default",
	"history.flag.all_stores":    "include authorized non-Steam store history in addition to Steam store history",
	"history.flag.sales":         "show historical discount windows instead of raw price-change points",
	...
	"section.news":               "News",
	"section.price_insights":     "Advanced pricing",
	...
	"label.url":                  "URL",
	"label.email":                "Email",
	"label.best_deal":            "Best current deal",
	"label.history_low":          "Historical low",
	"label.best_ever_deal":       "Best-ever deal",
	"label.steam_store_low":      "Steam store low",
	"label.bundle_count":         "Bundle appearances",
	"label.price_page":           "Price page",
	"label.deal_link":            "Deal link",
	"history.observed_since":     "Observed since %s",
	"history.status_active":      "active",
	"history.status_finished":    "finished",
...
var zhCN = map[string]string{
	...
	"flag.itad_key":              "高级价格增强 API key；默认读取 STEAM_CLI_ITAD_KEY",
	"flag.help":                  "查看该命令帮助",
	...
	"history.short":              "查看游戏的 Steam 价格历史，并可选扩展到授权商店",
	"history.example":            "  steam-cli history 264710\n  steam-cli history 264710 --days 30\n  steam-cli history 264710 --all-stores",
	"stores.short":               "列出高级价格后端使用的商店映射",
	...
	"price.flag.enhanced":        "包含可选第三方价格服务提供的高级价格增强信息",
	"app.flag.news":              "包含的新闻条数；0 表示不拉取新闻",
	"app.flag.enhanced":          "包含可选第三方价格服务提供的高级价格增强信息",
	"media.flag.probe":           "对每个 CDN 资源做 HEAD 探测，输出 HTTP 状态与可用性",
	"similar.flag.count":         "返回的相似游戏数量",
	"deals.flag.count":           "返回的条目数量",
	"deals.flag.filter":          "列表筛选：specials、discountedtopsellers、preordertopsellers、topsellers、new、comingsoon",
	"deals.flag.any":             "逗号分隔条件，满足任一条件即可：discounted、preorder",
	"deals.flag.all":             "逗号分隔条件，必须全部满足：discounted、preorder",
	...
	"history.flag.days":          "拉取最近 N 天内的价格变化；0 表示使用 API 默认值",
	"history.flag.all_stores":    "在 Steam 商店历史之外，同时包含授权商店历史",
	"history.flag.sales":         "显示历史折扣窗口，而不是原始价格变动点",
	...
	"label.url":                  "URL",
	"label.email":                "邮箱",
	"label.best_deal":            "当前最优 deal",
	"label.history_low":          "历史低价",
	"label.best_ever_deal":       "历史最佳 deal",
	"label.steam_store_low":      "Steam 商店史低",
	"label.bundle_count":         "Bundle 出现次数",
	"label.price_page":           "价格页面",
	"label.deal_link":            "Deal 链接",
	"history.observed_since":     "观测起点：%s",
	"history.status_active":      "进行中",
	"history.status_finished":    "已结束",
